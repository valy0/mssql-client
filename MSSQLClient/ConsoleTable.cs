...
namespace MSSQLClient
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = MSSQLClient.Format.Default)
        {
            switch (format)
            {
                case MSSQLClient.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case MSSQLClient.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case MSSQLClient.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case MSSQLClient.Format.Minimal:
